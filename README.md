...
### 4. 将解压后的文件复制，粘贴到前端项目的static/iconfont文件夹下，并在static文件夹下新建common.css文件作为全局样式文件，打开nuxt.config.js，配置全局样式文件在link数组中添加{ rel: 'stylesheet' , type:'text/css' , href:'/common.css' }，在commo.js中引入iconfont,代码如下，然后重启项目
`css
